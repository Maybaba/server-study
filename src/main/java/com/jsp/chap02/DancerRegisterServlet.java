...
/**
 * 만약 클라이언트가 /chap02/dancer/register URL로 요청을 보내면
 * 댄서를 등록할 수 있는 양식 HTML을 응답해주세요
 */
...
public class DancerRegisterServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            ...
            w.write("<label><button id=\"reg-btn\" type=\"submit\">등록</button></label>"); //등록버튼을 누러면 form action으로 들어간다.
            w.write("</form>");
            w.write("</body>\n");
            w.write("</html>");
